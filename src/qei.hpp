...
// void qei_setup_x4(pcnt_unit_t pcnt_unit, int gpioA, int gpioB) // 4倍(AB相) 4倍にすると、1回転あたりのカウント数が4倍になる
// {
...
void qei_setup_x1(pcnt_unit_t pcnt_unit, int gpioA, int gpioB) // 1倍(AB相) 
{
  pcnt_config_t pcnt_confA;
